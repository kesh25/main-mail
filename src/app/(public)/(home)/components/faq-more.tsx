...
const FAQMORE = () => (
    <div className="px-3 relative bg-secondary w-[400px] min-h-[300px] rounded-lg bg-white dark:bg-black">
        <HeroHighlight className="flex flex-col gap-4 justify-center items-center">
            <AppImage 
                src={icons.support}
                alt="support icon"
                title="support icon"
